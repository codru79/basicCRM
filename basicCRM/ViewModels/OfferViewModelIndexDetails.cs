...
{
    public class OfferViewModelIndexDetails
    {
        ...
        public OfferViewModelIndexDetails(OfferModel model, OpportunityRepository orepository, EmployeeRepository erepository)
        { 
